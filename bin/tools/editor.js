...
var Editor = (function () {
    function Editor() {
        var configuration = config_1.default.get('config');
        this.os = (0, os_1.platform)();
    ...
    Editor.prototype.create = function (file) {
        return __awaiter(this, void 0, void 0, function () {
            var filepath;
            return __generator(this, function (_a) {
                filepath = file;
                this.proc = (0, child_process_1.spawn)(this.command, [filepath]);
                return [2];
            });
        });
    };
