...
auth
    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                if (!options.username) return [3 /*break*/, 1];
                _a = options;
                return [3 /*break*/, 3];
            ...
            case 4:
                ...
                return [4 /*yield*/, api_1.default.post("/user/auth/local/login", {
                        username: username,
                        password: password
                    }, {
                        headers: {
            ...
            case 5:
                ...
                return [4 /*yield*/, config_1.default.set({ user: { username: username, id: id } })];
            case 6:
                _c.sent();
                return [4 /*yield*/, config_1.default.set({ api: api_config })];
            case 7:
                _c.sent();
...
auth.command("stats")
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                if (!!config_1.default.get('user')) return [3 /*break*/, 1];
