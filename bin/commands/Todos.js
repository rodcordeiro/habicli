...
var defaults_1 = require("../tools/defaults");
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            return [2, new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4, api_1.default.post("/tasks/".concat(id, "/score/up"), {}, {
                                    headers: headers
                                })
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            return [2, new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4, api_1.default.post("/tasks/".concat(task_id, "/checklist/").concat(item_id, "/score"), {}, {
                                    headers: headers
                                })
                                    .then(function (response) {
            ...
            return [2, new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                tasks = [];
                                return [4, api_1.default.get("/tasks/user?type=todos", {
                                        headers: headers
                                    })
                                        ...
                                        return __generator(this, function (_a) {
                                            switch (_a.label) {
                                                case 0: return [4, getTags(headers)];
                                                case 1:
                                                    uTags = _a.sent();
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                spinner.stop();
                return [2];
            case 1: return [4, listTasks(headers)
                    .then(function (response) {
            ...
            case 4:
                ...
                _a = action;
                switch (_a) {
                    case "Checklist": return [3, 5];
                    case "Complete": return [3, 15];
                    case "Delete": return [3, 17];
                    case "Update": return [3, 19];
                    case "Close": return [3, 38];
                }
                return [3, 39];
            ...
            case 6:
                item = _b.sent();
                lineBreak();
                console.log(chalk_1.default.cyanBright("##> ".concat(item.text)));
                lineBreak();
                return [4, inquirer_1.default.prompt([{
                            type: 'list',
                            name: 'action',
            ...
            case 7:
                item_action = _b.sent();
                if (!(item_action == "Complete")) return [3, 9];
                return [4, completeChecklistItem(task_1.id, item.id, headers)
                        .then(function (response) {
            ...
            case 8:
                ...
                _b.label = 9;
            case 9:
                if (!(item_action == "Update")) return [3, 12];
                return [4, inquirer_1.default.prompt([{
                            type: 'string',
                            name: 'text',
            ...
            case 10:
                text = (_b.sent()).text;
                return [4, api_1.default.put("/tasks/".concat(task_1.id, "/checklist/").concat(item.id), {
                        text: text
                    }, { headers: headers })
                        .then(function (response) {
            ...
            case 11:
                ...
                _b.label = 12;
            case 12:
                if (!(item_action == "Delete")) return [3, 14];
                return [4, api_1.default.delete("/tasks/".concat(task_1.id, "/checklist/").concat(item.id), { headers: headers })
                        .then(function (response) {
                        console.log(chalk_1.default.cyanBright("Updated"));
                    })
                        .catch(function (err) {
            ...
            case 13:
                ...
                _b.label = 14;
            case 14: return [3, 39];
            case 15: return [4, complete(task_1.id, headers)
                    .then(function (response) {
                    return response;
                })
            ...
            case 16:
                ...
                return [3, 39];
            case 17: return [4, api_1.default.delete("/tasks/".concat(task_1.id), { headers: headers })
                    .then(function (response) {
            ...
            case 18:
                _b.sent();
                return [3, 39];
            case 19: return [4, inquirer_1.default.prompt([{
                        type: 'list',
                        name: 'choice',
            ...
            case 21:
                text = _b.sent();
                return [4, api_1.default.put("/tasks/".concat(task_1.id), {
                        text: text
                    }, { headers: headers })
                        .then(function (response) {
                        console.log(chalk_1.default.cyanBright("Updated"));
            ...
            case 25:
                ...
                _b.label = 26;
            case 26:
                if (!(choice == 'Tags')) return [3, 32];
                console.log("Existing tags are:".concat(task_1.tags.map(function (tag) { return " ".concat(tag.name); })));
                return [4, inquirer_1.default.prompt([{
                            type: 'list',
                            name: 'choice',
            ...
            case 27:
                ...
                if (!(choice_1 == "Add tags")) return [3, 30];
                return [4, getTags(headers)];
            case 28:
                tags_1 = _b.sent();
                ...
                return [4, inquirer_1.default.prompt([{
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    if (!(response.tag != 'Empty')) return [3, 2];
                                    tag = tags_1.filter(function (t) { return t.name == response.tag; })[0];
                                    return [4, api_1.default.post("/tasks/".concat(task_1.id, "/tags/").concat(tag.id), {}, { headers: headers }).catch(function (err) { return console.log(chalk_1.default.redBright(err)); })];
                                case 1:
                                    _a.sent();
                                    return [3, 3];
                                case 2:
            ...
            case 29:
                ...
                _b.label = 30;
            case 30:
                if (!(choice_1 == "Remove tags")) return [3, 32];
                tags_2 = task_1.tags;
                return [4, inquirer_1.default.prompt([{
                            type: 'list',
                            name: 'tag',
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    ...
                                    return [4, api_1.default.delete("/tasks/".concat(task_1.id, "/tags/").concat(tag.id), { headers: headers }).catch(function (err) { return console.log(chalk_1.default.redBright(err)); })];
                                case 1:
                                    _a.sent();
                                    return [3, 3];
                                case 2:
            ...
            case 31:
                ...
                _b.label = 32;
            case 32:
                if (!(choice == 'Add checklist item')) return [3, 37];
                text = "1";
                _b.label = 33;
            case 33:
                if (!text) return [3, 37];
            ...
            case 34:
                text = _b.sent();
                if (!(text && text != null)) return [3, 36];
                return [4, api_1.default.post("/tasks/".concat(task_1.id, "/checklist"), {
                        text: text
                    }, { headers: headers })
                        .then(function (response) {
...
Todo.command('create')
    ...
    return __generator(this, function (_d) {
        switch (_d.label) {
            ...
            case 7:
                notes = (_b).notes;
                if (!options.priority) return [3, 8];
                _c = options;
                return [3, 10];
            ...
            case 10:
                ...
                if (notes)
                    task['notes'] = notes;
                task['priority'] = defaults_1.PRIORITIES[priority];
                task['attribute'] = defaults_1.ATTRIBUTE['Intelligence'];
                return [4, api_1.default.post('/tasks/user', task, { headers: headers })
                        .then(function (response) {
                        if (!options.verbose) {
